...
//
//	mockgen -typed -package quic -self_package github.com/fanglinhan/fork-quic-go -self_package github.com/fanglinhan/fork-quic-go -destination mock_packetconn_test.go net PacketConn
//
